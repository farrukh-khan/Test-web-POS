...
angular
    .module('naut')
    .controller('HeaderNavController', ['$scope', '$rootScope', '$location', '$modal', '$window', 'authService', 'localStorageService', 'ngAuthSettings', '$remember', '$timeout', 'modalService', '$forget',


function ($scope, $rootScope, $location, $modal, $window, authService, localStorageService, ngAuthSettings, $remember, $timeout, modalService, $forget) {
