'use strict';
angular.module('naut').controller('loginController', ['$scope', '$location', '$modal', '$window', 'authService', 'localStorageService', 'ngAuthSettings', '$remember', '$timeout', 'modalService', '$forget', '$rootScope',


    function ($scope, $location, $modal, $window, authService, localStorageService, ngAuthSettings, $remember, $timeout, modalService, $forget, $rootScope) {
